...
I think this graph is trying to show that the number of disease cases decreased dramatically after vaccines being licensed (or expanded recommandation), and further visually prove that vaccines have positive effect on eliminatin these diseases.
...
2. Number of cases is represented by the bubble size, and the plot is highly overlapped. In the major parts of the graph, the dismeters of the bubbles are easier to be visualised rather than the areas.  
...
Advantages:  
1. The effect of vaccine is clearly showed by the width of voilin plot.  

Disadvantages:  
1. Contains much less information than Jia You's graph.  
2. For diseases with low number of cases, the voilin plot looks like a straight line.  
