...
## Problems
Tables  
1. They are unorganized. They were even messier (as hw3-original data.xls).  
...
```
At first, I plotted each comparison individually, as hw3-plot1 to hw3-plot4, then I found the above way performs better.
